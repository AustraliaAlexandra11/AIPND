...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           #Separate the file extension from filename.
           #Root = file_root[0]. Extension = file_root[1]
           file_root = os.path.splitext(in_files[idx])
           ...
           #split file name into a list of words
           file_name = file_root[0].lower().split("_")
