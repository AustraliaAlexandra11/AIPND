...
def print_results(results_dic, results_stats_dic, model,
    ...
    for key in results_stats_dic:
        ...
        #           the letter p. Write a conditional
        #           statement that determines if the key starts with the letter
        #           'p' and then use a print statement to print
    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            if ((results_dic[key][3] == 1 and results_dic[key][4] == 0) or (results_dic[key][3] == 0 and results_dic[key][4] == 1)):
                print("Incorrect Classification for Pet Label: {} and Classifier Label: {}".format(results_dic[key][0],results_dic[key][1]))
